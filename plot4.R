...
plot(datetime, dataR$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)
plot(datetime, dataR$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(datetime, dataR$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()